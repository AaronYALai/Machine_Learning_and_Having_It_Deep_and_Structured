...
# @Last Modified time: 2016-11-07 02:15:13
...
def construct_LSTM(n_input, n_output, n_hid_layers=2, archi=128, lr=1e-3,
    ...
    lstm_train = th.function(inputs=[x_seq, y_hat, minibatch, stop_dropout],
...
def train_LSTM(trainX, train_label, forward, valid, lstm_train, n_output,
               int_str_map, dropout_rate, batchsize, epoch=10,
               valid_ratio=0.2, print_every=20):
    ...
    for j in range(epoch):
        ...
        for ind, num in enumerate(indexes):
            ...
            costs += lstm_train(X_seq, trainY[speakers[num]], minibat_ind, 1)
...
def run_LSTM_model(train_file, train_labfile, train_probfile, test_file=None,
    ...
    """Run the bidirectional deep LSTM network with droput"""
